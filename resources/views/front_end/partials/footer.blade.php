      ...
      <div class="container">
        <div class="row">
          <div class="footer-col-1 col-md-3 col-sm-12">
            <a href="index.html">
              <img alt="jobBox" src="{{ asset('front_end/assets/imgs/template/jobhub-logo.svg') }}">
            </a>
          ...
          <div class="footer-col-6 col-md-3 col-sm-12">
            ...
            <div class="mt-15">
              <a class="mr-5" href="#">
                <img src="{{ asset('front_end/assets/imgs/template/icons/app-store.png') }}" alt="jobBox">
              </a>
              <a href="#">
                <img src="{{ asset('front_end/assets/imgs/template/icons/android.png') }}" alt="jobBox">
              </a>
            </div>
          </div>
        </div>
        <div class="footer-bottom mt-50">
          <div class="row">
            <div class="col-md-6">
              <span class="font-xs color-text-paragraph">Copyright &copy; 2022. JobBox all right reserved</span>
            </div>
